...
import com.sxjun.site.common.DateUtils;
import com.sxjun.site.common.FileUtils;
import com.sxjun.site.common.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String className = "RDatabaseIndex";			// 类名，例：user
		String classAuthor = "sxjun";		// 类作者，例：ThinkGem
		String functionName = "索引设置";			// 功能名，例：用户
